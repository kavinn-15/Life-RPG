...
public class DataSeeder implements CommandLineRunner {
        ...
        private void cleanupDemoUser() {
                userRepository.findByEmail("alex@liferpg.app").ifPresent(user -> {
                        log.info("Purging demo account alex@liferpg.app...");
                        ...
                        log.info("Demo account alex@liferpg.app successfully removed.");
                });
        }
