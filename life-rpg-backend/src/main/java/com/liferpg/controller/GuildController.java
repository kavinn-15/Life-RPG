...
@Tag(name = "Guilds & Community", description = "Guild formation, expeditions, tavern chat, and player syndicates")
public class GuildController {
    ...
    private Long resolveUserId(UserPrincipal principal) {
        ...
        return userRepository.findByEmail("alex@liferpg.app")
                .map(com.liferpg.entity.User::getId)
                .orElseGet(() -> userRepository.findAll().stream().findFirst().map(com.liferpg.entity.User::getId).orElse(1L));
    }
