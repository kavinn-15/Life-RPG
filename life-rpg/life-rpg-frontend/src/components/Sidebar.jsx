    ...
    >
      <div className="flex flex-col gap-5">
        <Link to="/" className="flex items-center gap-3 px-2">
          <div className="w-10 h-10 rounded-2xl bg-[#5b4be2] flex items-center justify-center shadow-[0_3px_0_#4029ba]">
            <span className="material-symbols-outlined text-white text-[23px]">swords</span>
          </div>
