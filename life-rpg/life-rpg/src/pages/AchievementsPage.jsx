...
function AchievementCard({ achievement, onSimulateUnlock }) {
  ...
  if (isUnlocked) {
    return (
      <div className="animate-card-pop bg-surface-container-lowest rounded-2xl p-5 shadow-sm flex flex-col gap-3 relative overflow-hidden">
        <div className="absolute -right-8 -top-8 w-24 h-24 rounded-full bg-tertiary-fixed-dim/20 blur-xl pointer-events-none" />
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col min-w-0">
            ...
            <Chip className="text-tertiary bg-tertiary-fixed w-fit mt-0.5">Unlocked</Chip>
          </div>
        </div>
    ...
    <div className="bg-surface-container-lowest rounded-2xl p-5 shadow-sm flex flex-col gap-3">
      ...
      <div className="flex items-center justify-between gap-2 mt-auto pt-1">
        ...
        <button
          ...
          className="font-label-caps text-label-caps text-primary hover:underline shrink-0"
          title="Dev tool: instantly unlock this achievement to preview the reveal animation"
        >
          Simulate Unlock
        </button>
      </div>
